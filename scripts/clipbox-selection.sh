...
aws --profile clipbox-writer s3 cp ~/.clipbox/capture.png s3://$CLIPBOX_URL_PREFIX/$UPLOAD_NAME --metadata-directive REPLACE --content-type image/png --acl public-read
