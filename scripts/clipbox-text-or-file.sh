...
aws --profile clipbox-writer s3 cp $FILENAME s3://${CLIPBOX_URL_PREFIX:-brianschiller-clipbox}/$UPLOAD_NAME --metadata-directive REPLACE --content-type $(file --mime-type --brief $FILENAME) --acl public-read
